...
window.onload = function () {
    for (let i = 0; i < 5; i++) {
        ...
        choice.id = choices[i];
        choice.src = choices[i] + "/workspaces/rpsls-game/assets/images/.png";
...
function selectChoice() {
    player = this.id;
    document.getElementById("player-choice").src = player + "/workspaces/rpsls-game/assets/images/.png";

//Code for computers random choice.
    computer = choices[Math.floor(Math.random() * 5)];
    document.getElementById("computer-choice").src = computer + "/workspaces/rpsls-game/assets/images/.png";
